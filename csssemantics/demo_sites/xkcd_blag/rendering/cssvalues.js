...
var taggedIntTags = {em : 300, ex : 301, px: 302, pt: 306, _in: 42, percent: 317, auto: 1, inherit: 2, string: 271};
...
function parseAttrib(value){
    ...
    else if (value.match(/^[0-9\.]+in/g)) return [taggedIntTags._in,parseFloat(value)];
...
function getValue(length, fontSize, parentWidth){
    ...
    if(length[0] == taggedIntTags.px){
        ...
        return length[1] / 0.75;
    else if (length[0] == taggedIntTags._in)
        return (length[1] * (72 / 0.75));
