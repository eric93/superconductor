...
function normalizeGrammar(o){
    return normalizeGrammarHelper(o,{posChilds: []});
}

function normalizeGrammarHelper(o,posParent){
    ...
    if(o.position && (o.position == "absolute" || o.position == "fixed")){
        ...
        //Positioned elements add themselves to children arrays
        posParent.posChilds.push(o);
    }
    else if(o.tagName.toLowerCase() != "text" && o.tagName != "flowrootc")
    {
    ...
    for(var i = 0 ; i < o.children.length; i++)
    {
        //o.refName == "child" iff o is the root node
        if(o.refName == "child" || (o.position && (o.position == "absolute" || o.position == "fixed")))
            normalizeGrammarHelper(o.children[i], o);
        else
            normalizeGrammarHelper(o.children[i], posParent);
    }
    filterChilds(o); //Positioned elements add themselves to posChilds arrays
    o.children = o.children.concat(o.posChilds);
    return o;
}

function filterChilds(o){
    o.children = o.children.filter(function (child) {
        return !(child.position && (child.position == "absolute" || child.position == "fixed"));
    });
}
