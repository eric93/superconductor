function row_childs_canvas ( _ale_arg0) { return _ale_arg0; }
...
function textbox_intrinsHeight ( _ale_arg1,  _ale_arg0,  _ale_arg2) { return _ale_arg0 * (_ale_arg1 + _ale_arg2); }
...
function textbox_render ( _ale_arg8,  _ale_arg7,  _ale_arg0,  _ale_arg9,  _ale_arg6,  _ale_arg2,  _ale_arg10,  _ale_arg5,  _ale_arg4,  _ale_arg3,  _ale_arg1) { return paintParagraph(_ale_arg0, _ale_arg1, _ale_arg2, _ale_arg3, _ale_arg4, _ale_arg5, _ale_arg6, _ale_arg7, _ale_arg8, _ale_arg9, _ale_arg10); }
...
function vbox_render ( _ale_arg4,  _ale_arg0,  _ale_arg3,  _ale_arg2,  _ale_arg1,  _ale_arg5) { return _ale_arg0 + paintLine(_ale_arg1, _ale_arg2, _ale_arg1 + _ale_arg3, _ale_arg2, _ale_arg4) + paintLine(_ale_arg1 + _ale_arg3, _ale_arg2, _ale_arg1 + _ale_arg3, _ale_arg2 + _ale_arg5, _ale_arg4) + paintLine(_ale_arg1 + _ale_arg3, _ale_arg2 + _ale_arg5, _ale_arg1, _ale_arg2 + _ale_arg5, _ale_arg4) + paintLine(_ale_arg1, _ale_arg2 + _ale_arg5, _ale_arg1, _ale_arg2, _ale_arg4); }
function vbox_computedWidth ( _ale_arg3,  _ale_arg2,  _ale_arg4,  _ale_arg0,  _ale_arg6,  _ale_arg5,  _ale_arg1) { return (! isEmptyInt(_ale_arg0)) ? valueInt(_ale_arg0) : ((! isEmptyInt(_ale_arg1)) ? (0.01 * valueInt(_ale_arg1) * _ale_arg2) : min(max(max(_ale_arg3, (! isEmptyInt(_ale_arg4)) ? valueInt(_ale_arg4) : 0), _ale_arg2), min(_ale_arg5, (! isEmptyInt(_ale_arg6)) ? valueInt(_ale_arg6) : _ale_arg5))); }
function vbox_childs_availableWidth ( _ale_arg0) { return _ale_arg0 - 10; }
...
function cols_cols_availableWidth ( _ale_arg1,  _ale_arg0) { return _ale_arg0 + (_ale_arg1 ? 0 : 0); }
function cols_cols_relY ( _ale_arg0) { return 5 + (_ale_arg0 ? 0 : 0); }
...
function hbox_computedWidth ( _ale_arg3,  _ale_arg2,  _ale_arg4,  _ale_arg0,  _ale_arg6,  _ale_arg5,  _ale_arg1) { return (! isEmptyInt(_ale_arg0)) ? valueInt(_ale_arg0) : ((! isEmptyInt(_ale_arg1)) ? (0.01 * valueInt(_ale_arg1) * _ale_arg2) : min(max(max(_ale_arg3, (! isEmptyInt(_ale_arg4)) ? valueInt(_ale_arg4) : 0), _ale_arg2), min(_ale_arg5, (! isEmptyInt(_ale_arg6)) ? valueInt(_ale_arg6) : _ale_arg5))); }
function hbox_computedHeight ( _ale_arg0,  _ale_arg1) { return isEmptyInt(_ale_arg0) ? _ale_arg1 : valueInt(_ale_arg0); }
function hbox_render ( _ale_arg4,  _ale_arg0,  _ale_arg3,  _ale_arg2,  _ale_arg1,  _ale_arg5) { return _ale_arg0 + paintLine(_ale_arg1, _ale_arg2, _ale_arg1 + _ale_arg3, _ale_arg2, _ale_arg4) + paintLine(_ale_arg1 + _ale_arg3, _ale_arg2, _ale_arg1 + _ale_arg3, _ale_arg2 + _ale_arg5, _ale_arg4) + paintLine(_ale_arg1 + _ale_arg3, _ale_arg2 + _ale_arg5, _ale_arg1, _ale_arg2 + _ale_arg5, _ale_arg4) + paintLine(_ale_arg1, _ale_arg2 + _ale_arg5, _ale_arg1, _ale_arg2, _ale_arg4); }
function hbox_childs_absY ( _ale_arg0,  _ale_arg1) { return _ale_arg0 + _ale_arg1; }
function hbox_childs_availableWidth ( _ale_arg0) { return _ale_arg0 - 10; }
function hbox_childs_absX ( _ale_arg1,  _ale_arg0) { return _ale_arg0 + _ale_arg1; }
...
function visit_textbox_0(node) {
  ...
  logger.log("        renderFontSize: " + getAttribSafe(node, "renderfontsize"));
  logger.log("        fontFamily: " + getInputAttribSafe(node, "fontfamily", '"Arial"'));
  setAttribSafe(node, "computedwidth", textbox_computedWidth(getAttribSafe(node, "intrinsprefwidth")));
...
function visit_vbox_0(node) {
  ...
  logger.log("    last init childs_lineh_last: " + getAttribSafe(node, "childs_lineh_last"));
    setAttribSafe(node, "childs_relx_init", (5));
...
function visit_col_1(node) {
  ...
  setAttribSafe(node, "numchilds_init", (0 + (getAttribSafe(node, "cellsready") ? 0 : 0)));
  setAttribSafe(node, "numchilds", getAttribSafe(node, "numchilds_init"));
  logger.log("      init numChilds: " + getAttribSafe(node, "numchilds_init"));
  logger.log("    last init numchilds: " + getAttribSafe(node, "numchilds"));
  (function () {
...
function visit_cols_1(node) {
  ...
  (function () {
    ...
    for (var i = 0; i < children.length; i++) {
      var child = children[i]; 
      setAttribSafe(child, "borderc", (getInputAttribSafe(node, "borderc", '#F00') + (getAttribSafe(node, "cellsready") ? 0 : 0)));
      ...
      setAttribSafe(child, "rely", (5 + (getAttribSafe(node, "cellsready") ? 0 : 0)));
...
(function () {
  ...
  (function () {
    ...
    for (var i = 0; i < children.length; i++) {
      var child = children[i]; 
      setAttribSafe(node, "intrinsminwidth", (max(getAttribSafe(node, "intrinsminwidth"), 10 + getAttribSafe(child, "intrinsminwidth"))));
      logger.log("         step intrinsMinWidth: " + getAttribSafe(node, "intrinsminwidth"));
      setAttribSafe(node, "intrinsprefwidth", (max(getAttribSafe(node, "intrinsprefwidth"), 10 + getAttribSafe(child, "intrinsprefwidth"))));
      logger.log("         step intrinsPrefWidth: " + getAttribSafe(node, "intrinsprefwidth"));
    }
  })();
...
(function () {
  ...
  (function () {
    ...
    for (var i = 0; i < children.length; i++) {
      var child = children[i]; 
      setAttribSafe(node, "intrinsminwidth", (getAttribSafe(node, "intrinsminwidth") + getAttribSafe(child, "intrinsminwidth") + 5));
      logger.log("         step intrinsMinWidth: " + getAttribSafe(node, "intrinsminwidth"));
      setAttribSafe(node, "intrinsprefwidth", (getAttribSafe(node, "intrinsprefwidth") + getAttribSafe(child, "intrinsprefwidth") + 5));
      logger.log("         step intrinsPrefWidth: " + getAttribSafe(node, "intrinsprefwidth"));
    }
...
(function () {
    ...
    for (var i = 0; i < children.length; i++) {
      var child = children[i]; 
      setAttribSafe(child, "availablewidth", (getAttribSafe(node, "availablewidth") + (getAttribSafe(node, "cellsready") ? 0 : 0)));
...
function visit_hbox_3(node) {
  ...
  setAttribSafe(node, "computedwidth", hbox_computedWidth(getAttribSafe(node, "intrinsminwidth"), getAttribSafe(node, "availablewidth"), getInputMaybeAttribSafe(node, "minwidth"), getInputMaybeAttribSafe(node, "width"), getInputMaybeAttribSafe(node, "maxwidth"), getAttribSafe(node, "intrinsprefwidth"), getInputMaybeAttribSafe(node, "percentwidth")));
  logger.log("    hbox_computedWidth: " + getAttribSafe(node, "computedwidth"));
  logger.log("        intrinsMinWidth: " + getAttribSafe(node, "intrinsminwidth"));
  logger.log("        availableWidth: " + getAttribSafe(node, "availablewidth"));
  logger.log("        minWidth: " + getInputMaybeAttribSafe(node, "minwidth"));
  logger.log("        width: " + getInputMaybeAttribSafe(node, "width"));
...
(function () {
  ...
  (function () {
    ...
    for (var i = 0; i < children.length; i++) {
      var child = children[i]; 
      setAttribSafe(child, "relrightx", ((getAttribSafe(i == 0 ? node : children[i-1], i == 0 ? ("childs_relrightx_init") : ("relrightx")) + 5 + getAttribSafe(child, "computedwidth") > getAttribSafe(node, "computedwidth")) ? (5 + getAttribSafe(child, "computedwidth")) : (getAttribSafe(i == 0 ? node : children[i-1], i == 0 ? ("childs_relrightx_init") : ("relrightx")) + 5 + getAttribSafe(child, "computedwidth"))));
...
(function () {
  ...
  setAttribSafe(node, "childs_relrightx_init", (5));
  setAttribSafe(node, "childs_relrightx_last", getAttribSafe(node, "childs_relrightx_init"));
  logger.log("      init childs@relRightX: " + getAttribSafe(node, "childs_relrightx_init"));
  logger.log("    last init childs_relrightx_last: " + getAttribSafe(node, "childs_relrightx_last"));
  (function () {
    ...
    for (var i = 0; i < children.length; i++) {
      var child = children[i]; 
      setAttribSafe(child, "relrightx", (5 + getAttribSafe(child, "computedwidth") ));
      logger.log("         step childs@relRightX: " + getAttribSafe(child, "relrightx"));
    }
  })();
...
(function () {
  ...
  setAttribSafe(node, "cols_relrightx_init", (5 + (getAttribSafe(node, "cellsready") ? 0 : 0)));
...
(function () {
  ...
  (function () {
    ...
    for (var i = 0; i < children.length; i++) {
      var child = children[i]; 
      setAttribSafe(child, "relrightx", (getAttribSafe(i == 0 ? node : children[i-1], i == 0 ? ("childs_relrightx_init") : ("relrightx")) + 5 + getAttribSafe(child, "computedwidth") ));
      logger.log("         step childs@relRightX: " + getAttribSafe(child, "relrightx"));
    }
  })();
...
(function () {
  ...
  setAttribSafe(node, "intrinsheight_init", (5 + (getAttribSafe(node, "cellsready") ? 0 : 0) + (getAttribSafe(node, "numchilds") == 0 ? 0 : 0)));
  setAttribSafe(node, "intrinsheight", getAttribSafe(node, "intrinsheight_init"));
  logger.log("      init intrinsHeight: " + getAttribSafe(node, "intrinsheight_init"));
  logger.log("    last init intrinsheight: " + getAttribSafe(node, "intrinsheight"));
  (function () {
...
(function () {
  ...
  logger.log("      init childs@relY: " + getAttribSafe(node, "childs_rely_init"));
  logger.log("    last init childs_rely_last: " + getAttribSafe(node, "childs_rely_last"));
    setAttribSafe(node, "intrinsheight_init", (5 + (getAttribSafe(node, "numchilds") == 0 ? 5 : 0)));
  setAttribSafe(node, "intrinsheight", getAttribSafe(node, "intrinsheight_init"));
  logger.log("      init intrinsHeight: " + getAttribSafe(node, "intrinsheight_init"));
  logger.log("    last init intrinsheight: " + getAttribSafe(node, "intrinsheight"));
  (function () {
    ...
    for (var i = 0; i < children.length; i++) {
      var child = children[i]; 
      setAttribSafe(child, "relboty", (getAttribSafe(i == 0 ? node : children[i-1], i == 0 ? ("childs_relboty_init") : ("relboty")) + 5 + getAttribSafe(child, "computedheight") ));
      logger.log("         step childs@relBotY: " + getAttribSafe(child, "relboty"));
      setAttribSafe(child, "rely", (getAttribSafe(i == 0 ? node : children[i-1], i == 0 ? ("childs_relboty_init") : ("relboty")) + 5));
      logger.log("         step childs@relY: " + getAttribSafe(child, "rely"));
      setAttribSafe(node, "intrinsheight", (getAttribSafe(node, "intrinsheight") + getAttribSafe(child, "computedheight") + 5));
      logger.log("         step intrinsHeight: " + getAttribSafe(node, "intrinsheight"));
    }
...
(function () {
  ...
  setAttribSafe(node, "childs_relboty_init", (5));
  setAttribSafe(node, "childs_relboty_last", getAttribSafe(node, "childs_relboty_init"));
  logger.log("      init childs@relBotY: " + getAttribSafe(node, "childs_relboty_init"));
  logger.log("    last init childs_relboty_last: " + getAttribSafe(node, "childs_relboty_last"));
    setAttribSafe(node, "intrinsheight_init", (10));
  ...
  (function () {
    ...
    for (var i = 0; i < children.length; i++) {
      ...
      setAttribSafe(child, "relboty", (5 + getAttribSafe(child, "computedheight") ));
      logger.log("         step childs@relBotY: " + getAttribSafe(child, "relboty"));
      setAttribSafe(node, "intrinsheight", (getAttribSafe(node, "intrinsheight") < (10 + getAttribSafe(child, "computedheight")) ? (10 + getAttribSafe(child, "computedheight")) : getAttribSafe(node, "intrinsheight") ));
      logger.log("         step intrinsHeight: " + getAttribSafe(node, "intrinsheight"));
    }
  })();

  setAttribSafe(node, "computedheight", hbox_computedHeight(getInputMaybeAttribSafe(node, "height"), getAttribSafe(node, "intrinsheight")));
  logger.log("    hbox_computedHeight: " + getAttribSafe(node, "computedheight"));
  logger.log("        height: " + getInputMaybeAttribSafe(node, "height"));
  logger.log("        intrinsHeight: " + getAttribSafe(node, "intrinsheight"));
  return true;
}
...
function visit_col_6(node) {
  ...
  setAttribSafe(node, "render", col_render(getAttribSafe(node, "borderc"), getAttribSafe(node, "canvas"), getAttribSafe(node, "computedwidth"), getAttribSafe(node, "absy"), getAttribSafe(node, "absx"), getAttribSafe(node, "tablecontentheight")));
...
function visit_vbox_6(node) {
  ...
  setAttribSafe(node, "render", vbox_render(getInputAttribSafe(node, "borderc", '#00FF00'), getAttribSafe(node, "canvas"), getAttribSafe(node, "computedwidth"), getAttribSafe(node, "absy"), getAttribSafe(node, "absx"), getAttribSafe(node, "computedheight")));
...
function visit_hbox_6(node) {
  logger.log("  visit  HBox (id: " + node.id + "): " + 6);
  setAttribSafe(node, "render", hbox_render(getInputAttribSafe(node, "borderc", '#00FF00'), getAttribSafe(node, "canvas"), getAttribSafe(node, "computedwidth"), getAttribSafe(node, "absy"), getAttribSafe(node, "absx"), getAttribSafe(node, "computedheight")));
