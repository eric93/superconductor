...
class HBox : HVBox {
    ...
    actions {
        loop childs {
            ...
            childs.bottom := (childs$i.bottom_delta_0) ? (bottom) : (childs$i.bottom_old_0) ;
...
class VBox : HVBox {
    ...
    actions {
        loop childs {
            ...
            childs.right := (childs$i.right_delta_0) ? (right) : (childs$i.right_old_0) ;
